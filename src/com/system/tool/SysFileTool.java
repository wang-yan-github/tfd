...
public class SysFileTool {
	/**
	   * 扩展哈希表

	   */
	  private static Map<Object, Object> extMap = new HashMap<Object,Object>();
	  ...
	  public static String appendFileName(String path, String name) {
	    ...
	    if (lastChar.equals(KeyConst.FILE_SEPERATOR)) {
	      return path + name;
	    }
	    return path + KeyConst.FILE_SEPERATOR + name;
	  }
	  ...
	  public static void loadLine2Array(String fileName,
	    ...
	    loadLine2Array(fileName,
	        startLine, endLine, rtList, SysConst.DEFAULT_CODE);
	  }
	  ...
	  public static void loadLine2Array(String fileName,
	    ...
	    loadLine2Array(fileName, startLine, Integer.MAX_VALUE, rtList, SysConst.DEFAULT_CODE);
	  }
	  ...
	  public static void loadLine2Array(String fileName, List rtList) throws Exception {
	    loadLine2Array(fileName, 0, Integer.MAX_VALUE, rtList, SysConst.DEFAULT_CODE);
	  }
	  ...
	  public static void storeString2File(String fileName, String content) throws Exception {
	    ...
	    try {
	      ...
	      storeString2File(outs, content, SysConst.DEFAULT_CODE);
	    }catch(Exception ex) {
	      throw ex;
	    }finally {
	      try {
	  ...
	  public static void storeArray2Line(String fileName, List rtList) throws Exception {
	    storeArray2Line(fileName, rtList, SysConst.DEFAULT_CODE);
	  }
	  ...
	  public static void copyFileEncrypt(
	    ...
	    copyFile0(
	        ...
	        SysConst.getSalt(null),
	        SysConst.getItCnt(null),
	        Cipher.ENCRYPT_MODE);
	  }
	  ...
	  private static void copyFile0(
	    ...
	    try {
	      ...
	      if (passWord != null) {
	        ...
	        if (cipher != null) {
	          ins = SysSecurityTool.buildPassWordInputStream(cipher, ins);
	        }else {
	          ins = SysSecurityTool.buildPassWordInputStream(
	  ...
	  public static void extractUpdateFile(
	    ...
	    Date cpDate = SysTool.parseDate(cpDateStr);
	    copyDir(srcDirName, destDirName, msrgList, new SysFileUitl(cpDate, true),
	        false, true);
	  }
	  ...
	  private static void copyDirImp0(String srcDirName,
	    ...
	    if (!srcDir.exists() || !srcDir.isDirectory()) {
	      throw new ErrorMessage("源文件目录输入不正确！");
	    }
	  ...
	  public static StringBuffer loadLine2Buff(String fileName,
	    ...
	    return loadLine2Buff(fileName, startLine, Integer.MAX_VALUE, SysConst.DEFAULT_CODE);
	  }
	  ...
	  public static StringBuffer loadLine2Buff(String fileName) throws Exception {
	    ...
	    return loadLine2Buff(fileName, 0, Integer.MAX_VALUE, SysConst.DEFAULT_CODE);
	  }
	  ...
	  public static String getFileNameNoExt(String filePath) {
	    ...
	    int pointIndex = rtName.lastIndexOf(SysConst.PATH_POINT);
	    if (pointIndex < 0) {
	      return rtName;
	    }
	    if (pointIndex == 0) {
	  ...
	  public static String getFileName(String filePath) {
	    ...
	    int startIndex = 0;
	    if (filePath.lastIndexOf(SysConst.PATH_SPLIT_FILE_WIN) >= 0) {
	      startIndex = filePath.lastIndexOf(SysConst.PATH_SPLIT_FILE_WIN) + 1;
	    }else if (filePath.lastIndexOf(SysConst.PATH_SPLIT_URL) >= 0) {
	      startIndex = filePath.lastIndexOf(SysConst.PATH_SPLIT_URL) + 1;
	    }
	  ...
	  public static String getFilePath(String fileName) {
	    ...
	    int tmpIndex = -1;
	    if (fileName.lastIndexOf(SysConst.PATH_SPLIT_FILE_WIN) >= 0) {
	      tmpIndex = fileName.lastIndexOf(SysConst.PATH_SPLIT_FILE_WIN);
	    }else if (fileName.lastIndexOf(SysConst.PATH_SPLIT_URL) >= 0) {
	      tmpIndex = fileName.lastIndexOf(SysConst.PATH_SPLIT_URL);
	    }
	    if (tmpIndex < 0) {
	      return "";
	    }
	   ...
	   * @throws Exception
	   */
	  public static void replaceInFile(String fileName,List<String[]> rules) throws Exception {
	  ...
	  public static byte[] loadByteArrayFromFile(
	    ...
	    try {
	      ...
	      if (salt != null) {
	        in = SysSecurityTool.buildPassWordInputStream(
	            passWord, salt, itCnt, mode, in);
	      }
	      
	      byte[] buff = new byte[SysConst.DEFAULT_IO_BUFF_SIZE];
	      int readLen = 0;
	  ...
	  public static void deleteFile(List fileList, String rootDir) throws Exception {
	    ...
	    for (int i = 0; i < fileList.size(); i++) {
	      ...
	      SysFileTool.deleteAll(currPath);
	    }
	  }
	  ...
	  public static boolean isFileEqual(File f1, File f2) throws Exception {
	    ...
	    try {
	      ...
	      byte[] buf1 = new byte[SysConst.K];
	      byte[] buf2 = new byte[SysConst.K];
	      for (int i = 0; i < SysConst.K; i++) {
	        buf1[i] = 0;
	        buf2[i] = 0;
	      }
	      while (true) {
	  ...
	  public static void copyNotExists(String srcDir, String destDir, String outDir, List msrgList) throws Exception {
	    if (SysTool.isNullorEmpty(srcDir) || SysTool.isNullorEmpty(destDir)) {
	      return;
	    }
	  ...
	  public static void copyDirDiff(String newDir, 
		  ...
		  SysFileDif filter = new SysFileDif(newDir, oldDir);
