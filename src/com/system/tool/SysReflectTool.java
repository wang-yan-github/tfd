...
public class SysReflectTool {
	  ...
	  public static boolean setValue(Object obj, String fieldName, Class fieldType, String fieldValue) throws Exception {
	    ...
	    if (fieldType.equals(int.class)) {
	      if (SysTool.isNullorEmpty(fieldValue)) {
	        return false;
	      }
	      ...
	      exeMethod(obj, methodName, new Class[]{Date.class}, new Object[]{SysTool.parseDate(fieldValue)});
	      return true;
	    }else if (fieldType.equals(java.sql.Date.class)) {
	      exeMethod(obj, methodName, new Class[]{java.sql.Date.class}, new Object[]{SysTool.parseSqlDate(fieldValue)});
	      return true;
