...
import tfd.system.unit.dept.logic.DeptImportLogic;
...
public class DeptImportAct {
	private DeptImportLogic logic=new DeptImportLogic();
	...
	public String templateDownload(HttpServletRequest request,HttpServletResponse response) throws Exception{
		...
		try {
			...
			String exportFileName="部门信息导入模板.xls";
	...
	public String dataImport(HttpServletRequest request,HttpServletResponse response) throws Exception{
		...
		return "/system/unit/dept/import.jsp";
	}
	/**
	 * 数据导入要求
	 * @param request
