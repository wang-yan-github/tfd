...
public class TestAct {
     ...
     * @throws Exception
     */
    public void addTestAct(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            test.setType(Integer.parseInt(request.getParameter("type")));
            TestLogic testLogic = new TestLogic();
            data = testLogic.addTestLogic(dbConn, test);
            dbConn.commit();
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
     ...
     * @throws Exception
     */
    public void getTestListAct(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            dbConn = DbPoolConnection.getInstance().getConnection();
            TestLogic testLogic = new TestLogic();
            returnData = testLogic.getTestListLogic(dbConn, pramList, pageSize, page, sortOrder, sortName);
            dbConn.commit();
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
    ...
    public void getNewsByNewsIdAct(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            pramList.add("," + deptId + ",");
            pramList.add(","
                    + userInfoLogic.getUserInfoByAccountId(dbConn, account.getAccountId()).getOtherDept()
                    + ",");
            pramList.add(","
                    + userInfoLogic.getUserInfoByAccountId(dbConn, account.getAccountId()).getPostPriv()
                    + ",");
            String newsId = request.getParameter("newsId");
            NewsLogic newsLogic = new NewsLogic();
    ...
    public void getNoReadNewsList(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            pramList.add(account.getOrgId());
            NewsLogic newsLogic = new NewsLogic();
            returnData = newsLogic.getNoReadNewsListLogic(dbConn, newstype, pramList, pageSize, page,
                    storOrder, storName);
            dbConn.commit();
        } catch (Exception e) {
            // TODO Auto-generated catch block
     ...
     * @throws Exception
     */
    public void getPassReadNewsList(HttpServletRequest request, HttpServletResponse response)
            throws Exception {
        Connection dbConn = null;
        ...
        try {
            ...
            returnDate = newsLogic.getPassReadNewsListLogic(dbConn, newstype, createTime, pramList, pageSize,
                    page, storOrder, storName);
            dbConn.commit();
        } catch (Exception e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
    ...
    public void gethistoryNewsAct(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            String newstype = request.getParameter("newstype");
            String createTime = request.getParameter("createTime");
            returnDate = newsLogic.gethistoryNewsLogic(dbConn, newstype, pramList, pageSize, page, storOrder,
                    storName, createTime);
            dbConn.commit();
        } catch (Exception e) {
            // TODO Auto-generated catch block
    ...
    public void publishNewsAct(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            if (request.getParameter("approvalStatus").equals("1")) {
                ...
                String accountId = "";
                if (news.getAccountId().equals("userAll") || news.getDeptPriv().equals("deptAll")
                        || news.getUserPriv().equals("privAll")) {
                ...
                messageApi.addMessage(dbConn, "news", smsRemindJson, "未读新闻", account.getAccountId(),
                        toAccountList, account.getOrgId(), request.getParameter("createTime"));
            }
            dbConn.commit();
        } catch (Exception e) {
            // TODO Auto-generated catch block
    ...
    /**
     * 当前新闻已存在的情况下发布新闻 Author: Wp
     * 
     * @param request
     * @param response
     * @throws Exception
     */
    public void publishUpdateNewsAct(HttpServletRequest request, HttpServletResponse response)
            throws Exception {
        int data = 0;
        Connection dbConn = null;
    ...
    public void QuerynewsAct(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            news.setContect(request.getParameter("contect"));
            NewsLogic newsLogic = new NewsLogic();
            data = newsLogic.querynewsLogic(dbConn, news, starttime, endtime, pageSize, page, sortOrder,
                    sortName);
            dbConn.commit();
        } catch (Exception e) {
            // TODO Auto-generated catch block
    ...
    public void alreadyapprovalAct(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            String orgId = account.getOrgId();
            NewsLogic newsLogic = new NewsLogic();
            data = newsLogic.alreadyapprovallogic(dbConn, accountId, orgId, pageSize, page, sortOrder,
                    sortName);
            dbConn.commit();
        } catch (Exception e) {
            // TODO Auto-generated catch block
    ...
    public void managenewsAct(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            if (request.getParameter("approvalStatus").equals("1")) {
                ...
                List<String> toAccountList = new ArrayList<String>();
                String accountId = "";
                if (request.getParameter("accountId").equals("userAll")
                        || request.getParameter("deptPriv").equals("deptAll")
                        || request.getParameter("userPriv").equals("privAll")) {
                    accountId = new AccountLogic().getorgIdAllLogic(dbConn, account.getOrgId());
                } else {
                    accountId += request.getParameter("accountId") + ",";
                    String deptPriv = request.getParameter("deptPriv");
    ...
    public void readtremAct(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            pramList.add(","
                    ...
                    + ",");
            pramList.add(account.getOrgId());
            data = newsLogic.readtremlogic(dbConn, pramList, news, starttime, endtime, pageSize, page,
                    sortOrder, sortName);
            dbConn.commit();
        } catch (Exception e) {
            // TODO Auto-generated catch block
    ...
    /**
     * 通过新闻ID 获取所有可读该新闻的人员信息 Author: Wp
     * 
     * @param request
     * @param response
     * @throws Exception
