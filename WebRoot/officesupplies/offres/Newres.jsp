...
<script type="text/javascript" src="<%=contextPath%>/officesupplies/offres/js/Newres.js"></script>

</head>
<body>
<form id="offresform" name="offresform" class="form-horizontal">
<div class="list-group-item"  style="padding: 0px;cursor: auto;">
<a style="cursor: auto;" class="list-group-item active">新建办公用品</a>
...
<input type="text" id="minStock" name="minStock" class="form-control "  >
  ...
  登记权限（用户）：
   ...
   <div class="col-xs-10 form-group">
         ...
         <a href="javascript:void(0);" onclick="userinit(['userPriv','staffName'],'false');">添加人员</a>
         </div>
   </td>
   </tr>
     <tr>
...
<input type="text" id="disName" name="disName" readonly="readonly" class="form-control "  >
  ...
  登记权限（部门）：
   ...
   <div class="col-xs-10 form-group">
<textarea rows="3" cols="40" name="deptName" id="deptName"  class="form-control" readonly="readonly" onchange=""></textarea>
</div>
<div style="margin-top: 40px;">
