...
<script type="text/javascript" src="<%=contextPath%>/officesupplies/officelibrary/js/updatelibrary.js"></script>
...
<a style="cursor: auto;" class="list-group-item active">修改办公用品库</a>
 <table class="table table-striped table-condensed">
          <tr>
          <td width="15%">办公用品库名称</td>
          <td>      
           <div class="col-xs-6 form-group">
           <input type="hidden" id="libraryId" name="libraryId" style="display:none"/>
			<input type="text" id="libraryName" name="libraryName" class="form-control "  placeholder="请输入名称......"></div>
        </td></tr>
     <tr>
     <td>所属部门</td>
     <td><div class="col-xs-6 form-group">
