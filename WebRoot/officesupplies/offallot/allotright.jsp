...
<script type="text/javascript" src="<%=contextPath%>/officesupplies/offallot/js/allotright.js"></script>
<title>办公用品调拨</title>
...
<body>
<div class="panel panel-info" style="width:94%;margin-left: 3%;margin-top: 1%;height: 300px;">
   <div class="panel-heading">
      <h3 class="panel-title">
       调拨
      </h3>
      </div>
   <form action="" method="post" id="offresform" name="offresform" class="form-horizontal">
   <div>
   <div class="panel-body" style="width: 44%; margin-top: 3%;margin-left:1%;float: left;"  >
...
<input type="text" id="beforeStock" name="beforeStock" class="form-control"/>
   ...
   <div style="float: left; margin-top: 8%;margin-left: 1%; width: 5%;">
   <img alt="" src="arrow.png" style="width: 100%;">
   </div>
   </div>
   <div class="panel-body" style="width: 44%; margin-top: 5%;margin-right:1%; float: right;"  >
