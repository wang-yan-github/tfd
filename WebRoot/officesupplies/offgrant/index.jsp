...
function doInit(){
	...
	$.addTab("tabs","tabs-content",{url:contextPath+"/officesupplies/offgrant/notgiveres.jsp",title:"待发放",active:true});
	$.addTab("tabs","tabs-content",{url:contextPath+"/officesupplies/offgrant/giveres.jsp",title:"已发放",active:false});
}
</script>
</head>
