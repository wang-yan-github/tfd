$(function(){
	...
	function getapply(){
		$("#myTable").datagrid({
			...
			rows:5,
	        collapsible: true,
	        url: contextPath+"/officesupplies/act/OffresapplyAct/getalreadyAct.act",
	        method: 'POST',
	        sortName:'ID',
	      	sortOrder:'DESC',
	        loadMsg: "数据加载中...",
	        ...
	        columns:[[
	            ...
	            {title: '申请人', field: 'USER_NAME', width: '12%', align: 'center'},
	            {title: '申请状态', field: 'APPLY_STATUS', width: '15%', align: 'center',
	            ...
	            {title: '发放状态', field: 'GIVE_STATUS', width: '8%', align: 'center',
	            	formatter:function(value,rowData,rowIndex){
