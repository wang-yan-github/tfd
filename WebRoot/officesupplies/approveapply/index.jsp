...
function doInit(){
	...
	$.addTab("tabs","tabs-content",{url:contextPath+"/officesupplies/approveapply/notapprove.jsp",title:"待审批",active:true});
	$.addTab("tabs","tabs-content",{url:contextPath+"/officesupplies/approveapply/alreadlyapply.jsp",title:"已审批",active:false});
}
</script>
</head>
