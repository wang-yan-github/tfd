...
<script type="text/javascript" src="<%=contextPath%>/officesupplies/offresapply/js/right.js"></script>
</head>
<body>
...
<div style="float: left;margin-left: 0px;width:180px;" class="col-xs-8 form-group">
