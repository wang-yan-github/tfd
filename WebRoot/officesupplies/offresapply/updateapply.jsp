...
<script type="text/javascript" src="<%=contextPath%>/officesupplies/offresapply/js/updateapply.js"></script>
...
<div class="list-group-item"  style="padding: 0px;cursor: auto;width:80%;margin-left: 10%;margin-top: 1%;">
<a style="cursor: auto;" class="list-group-item active">修改申领记录</a>
...
<input type="button" value="-" id="btnminus"   style="font-weight: 20px;" class="btn btn-default" onclick="btnminusfun();" ></input>
</div>
<div class="col-xs-4 form-group" style="float: left;margin-left: 0px;">
<input id="applyNum" name="applyNum" class="form-control"  onblur="blurjudge();" />
</div>
<div style="float: left;" >
<input type="button" value="+" id="btnplus" onclick="btnplusfun();" class="btn btn-default"></input>
...
<textarea rows="4" cols="40" id="applyRemary" name="applyRemary" class="form-control"></textarea>
   ...
   <div align="center">
  <button type="submit" name="send" class="btn btn-primary">确认</button>
