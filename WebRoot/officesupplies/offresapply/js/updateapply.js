...
function getapplyId(){
	...
	$.ajax({
		...
		success:function(data){
			...
			$("#applyNum").val(data.applyNum);
			$("#approvalStaff").val(data.approvalStaff);
			$("#userName").val(data.userName);
			$("#applyRemary").val(data.applyRemary);
		}
	});
}
function getlibrary(){
...
function updateresapply(){
	...
	para+="&applyId="+applyId;
	var url=contextPath+"/officesupplies/act/OffresapplyAct/updateapplyAct.act";
	$.ajax({
		url:url,
		type:"POST",
		data:para,
