...
function doInit(){
	...
	$.addTab("tabs","tabs-content",{url:contextPath+"/officesupplies/offmaint/maint.jsp",title:"库存维护",active:true});
	$.addTab("tabs","tabs-content",{url:contextPath+"/officesupplies/offmaint/agentapply.jsp",title:"代登记",active:false});
	$.addTab("tabs","tabs-content",{url:contextPath+"/officesupplies/offmaint/message.jsp",title:"维护记录",active:false});
}
</script>
</head>
