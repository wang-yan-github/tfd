...
<script type="text/javascript" src="<%=contextPath%>/metting/boardroom/js/updateboardroom.js"></script>
...
<a style="cursor: auto;" class="list-group-item active">修改会议室信息</a>
...
<input type="text" name="boardroomuserName" readonly="readonly" id="boardroomuserName" class="form-control"></input>
</div>
...
<tr>
	...
	<td>
	<div  id="editor" name="editor" type="text/plain" style="width: 80%; height: 180px;" ></div>
