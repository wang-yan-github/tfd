...
function init(){
	...
	$.addTab("tabs","tabs-content",[{title:"纪要列表",url:contextPath+"/metting/summary/summarytable.jsp",active:true},
	                                {title:"纪要查询",url:contextPath+"/metting/summary/querysummary.jsp",active:false}
	                                ]);
}
</script>
</head>
