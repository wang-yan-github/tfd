...
<script type="text/javascript" src="<%=contextPath%>/metting/summary/js/updatesummary.js"></script>
...
<a style="cursor: auto;" class="list-group-item active">修改会议纪要</a>
...
<script type="text/javascript">CKEDITOR.replace('editor')</script>
   ...
   <div align="center">
<button type="button" name="save" onclick="updatesummary();" class="btn btn-primary">保存</button>
