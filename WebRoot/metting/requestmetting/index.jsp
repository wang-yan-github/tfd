...
function init(){
	...
	$.addTab("tabs","tabs-content",[
	                                {title:"待批会议",url:contextPath+"/metting/requestmetting/noratifyrequest.jsp",active:true},
	                                {title:"已准会议",url:contextPath+"/metting/requestmetting/ratifyrequest.jsp",active:false},
	                                {title:"未批准会议",url:contextPath+"/metting/requestmetting/notratifyrequest.jsp",active:false},
	                                {title:"会议查询",url:contextPath+"/metting/requestmetting/querymeeting.jsp",active:false}
	                                ]);
}
</script>
</head>
