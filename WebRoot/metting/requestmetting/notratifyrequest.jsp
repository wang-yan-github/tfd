...
<title>查看未批准会议</title>
<script type="text/javascript" src="lookapproval.js"></script>

<script type="text/javascript" >
$(function(){
	getnotratify();
});
function getnotratify(){
	$("#myTable").datagrid({
        width: document.body.clientWidth,
		rows:5,
        collapsible: true,
        url: contextPath+"/meeting/act/MeetingrequestAct/notratifyrequestAct.act",
        method: 'POST',
        sortName:'ID',
      	sortOrder:'DESC',
        loadMsg: "数据加载中...",
...
function lookapproval(requestId){
	lookapprovalmeeting(requestId);
}
</script>
</head>
<body>
