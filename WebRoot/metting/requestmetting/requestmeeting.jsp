...
$(function (){
	...
	filesUpLoad("meeting");
	getIdboardroom();
	$("#meetingStarttime").val(statrTime);
...
function addmeeting(){
	...
	var url=contextPath+"/meeting/act/MeetingrequestAct/addrequestAct.act";
	...
	para+="&meetingDevice="+meetingDevice;
	}
...
<a href="javascript:void(0);" onclick="userinit(['meetingSumman','SummanName'],'true','SummanNameval');">添加人员</a>
  ...
  <tr>
   <td >周期性会议申请:</td>
    <td >
    <div class="col-xs-12">
    	<input type="radio" name="meetingType" id="meetingType" value="1" onclick="cycclick();" />是 
    	<input type="radio" name="meetingType" id="meetingType" value="0" checked="true" onclick="cycnoclick();" />否 
    	</div>
    </td>
    <td> 提前时间：</td>
    <td >
    <div class="col-xs-12 form-group"  ><select style="float:left;" class="form-control BigSelect" id="warnTime" name='warnTime' >
              <option selected="selected" value="15">15分钟前</option>
  ...
  <td>
  <div class="col-xs-12">
    	<input type="radio" name="cycType" id="cycType" value="2" />天
    	<input type="radio" name="cycType" id="cycType" value="3" checked="true" />周
    	<input type="radio" name="cycType" id="cycType" value="4"  />月
    	<input type="radio" name="cycType" id="cycType" value="5"  />年
    	</div>
  </td>
  <td>
  周期结束时间：
...
<div>
  ...
  <tr >
    <td colspan="4" align="center">
      <input type="submit" disabled="disabled" value="确定" class="btn btn-primary" >&nbsp;&nbsp;
