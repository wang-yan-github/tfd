...
function init(){
	...
	$.addTab("tabs","tabs-content",[{title:"待批会议",url:contextPath+"/metting/approvalmetting/waitrequest.jsp",active:true},
	                                {title:"已准会议",url:contextPath+"/metting/approvalmetting/viarequest.jsp",active:false},
	                                {title:"未批准会议",url:contextPath+"/metting/approvalmetting/notviarequest.jsp",active:false}
	                                ]);
}
</script>
</head>
