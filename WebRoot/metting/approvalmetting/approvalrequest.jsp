...
function approvalmeeting(){
	var status;
	var url=contextPath+"/meeting/act/ApprovalmeetingAct/addappmeetingAct.act";
...
function notpassmeeting(){
	...
	$.ajax({
		   ...
		   type:'post',
	   		...
	   		success:function(data){
	   			if(data!=0){	   			
	   			parent.layer.msg('不通过成功！',function(){});
	   			history.back();
	   			}
	   		}
	   });
...
<a style="cursor: auto;" class="list-group-item active">会议审批</a>
