...
<title>修改会议室设备</title>
<%String boardroomdeviceId=request.getParameter("boardroomdeviceId"); %>
<script type="text/javascript" charset="utf-8" src="<%=contextPath%>/system/jsall/ckeditor_full/ckeditor.js"></script>
<script type="text/javascript" src="<%=contextPath%>/metting/boardroomdevice/js/updateboardroomdevice.js"></script>
<script type="text/javascript">
var boardroomdeviceId="<%=boardroomdeviceId%>";
</script>
</head>
<body>
...
<a style="cursor: auto;" class="list-group-item active">修改会议室设备</a>
