...
<script type="text/javascript" src="<%=contextPath%>/calendar/leader/js/add.logic.js"></script>
...
<form   method="post" name="form1" id="form1" class="form-horizontal" >
	...
	<input   type="hidden" name="accountIds" id="Up_accountId" value="<%=accountId %>" />
	...
	<div class="panel-body" style="border:none;" >
	 <table class="table table-striped" width="100%" align="center">
		...
		<tr>
			<td nowrap>事务类型：</td>
			<td nowrap align="left"><div class="col-xs-8 form-group" >
				 <select style="float:left;" class="form-control" name="calType" id="calType">
		...
		<td nowrap>频率：</td>
	     ...
	     <tr id="remindTimeTr" style="display:none;">
			...
			<td nowrap align="left"><div class="col-xs-12 form-group" >
         	...
         	<input id="remindTime" value="00:00:00" name="remindTime" value='' type="text" onclick="setRemindTime(this);" style="width:25%;float:left;" class="form-control BigInput easyui-validatebox" validType="time[]"   data-placement="right" data-content="" data-toggle="popover" data-html="true">&nbsp;为空为当前时间</div>
			</td>
	    </tr>
	    <tr id="endTr" style="display:none;" >
			<td nowrap>结束重复：</td>
			<td nowrap align="left"><div class="col-xs-8 form-group"  >
			 	<input type="text" readonly="readonly"  name="endWhile" style="float:left;" id="endWhile" class="form-control BigInput" onClick="WdatePicker({dateFmt:'yyyy-MM-dd '})"/></div>
        	</td>
		</tr>
		<tr>
		<td nowrap>参与者：</td>
		<td nowrap align="left"><div class="col-xs-8 form-group" >
			...
			<textarea  name="userName" id="userName" style="float:left;" onClick="selectUser(['accountId','userName']);" class="form-control" required="true" rows="2" cols="35" readonly="readonly"></textarea>
		    </div>
       </td>
