...
.bottomDiv{width:80%;margin-left:10%;margin-top:20px;}
...
<span class="title_name" style="float:left;" >周期日程</span>
</div>
<div style=" float:right; width:420px;margin-top:6px;margin-right:20px;" class="btn-group" role="group" aria-label="..." >
	...
	<button style="float:right;" class="btn btn-primary" onclick="goPeriodicity();" >周期日程</button>
...
<div class="input-group" style="width:240px;">
	...
	<div id="myTable" ></div>
<button type="button" id="btn_back" style="margin-top:20px;" class="btn btn-default">返回</button>
</div>
