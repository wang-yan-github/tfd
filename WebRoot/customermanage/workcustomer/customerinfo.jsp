...
function doInit(){
	...
	$.addTab("tabs","tabs-content",[{title:"我的合作伙伴",url:contextPath+"/customermanage/workcustomer/customerTable.jsp",active:true},
	                                {title:"下属的合作伙伴",url:contextPath+"/customermanage/workcustomer/branchcustomer.jsp",active:false},
	                                {title:"参与的合作伙伴",url:contextPath+"/customermanage/workcustomer/sharecustomer.jsp",active:false}
	                                ]);
}
</script>
</head>
