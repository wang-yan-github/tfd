...
function init(){
	var url=contextPath+"/customermanage/act/CustomerinfoAct/sharecustomerAct.act?status="+2;
	gettable(url);
}
...
<span class="title_name" >参与的合作伙伴</span>
</div>
<div id="btnitem">
   ...
   <td width="12%">客户名称：</td>
   <td width="36%">
   <input type="hidden" name="termtype" id="termtype" value="3"></input>
