...
function init(){
	var url=contextPath+"/customermanage/act/CustomerinfoAct/branchcustomerAct.act?status="+2;
	gettable(url);
}
			...
			{title: '全选', field: '', width: '2%', align: 'center',sortable:true,checkbox:true},  
           	{title: '客户名称', field: 'CUSTOMER_NAME', width: '20%', align: 'center',sortable:true,
           		formatter:function(value,rowData,rowIndex){
					return '<a href=javascript:void(0); onclick=showcuctomer("'+rowData.CUSTOMER_ID+'","2")>'+rowData.CUSTOMER_NAME+'</a>';
				}	
           	},
           	...
           	{title: '行业类型', field: 'TRADE_TYPE', width: '15%', align: 'center',sortable:true},
...
function searchclick(){
	var url=contextPath+"/customermanage/act/CustomerinfoAct/gettermTypecusAct.act";
	gettable(url);
}
</script>
</head>
...
<span class="title_name" >下属的合作伙伴</span>
</div>
<div id="btnitem">
   ...
   <td width="12%">客户名称：</td>
   <td width="36%">
   <input type="hidden" name="termtype" id="termtype" value="2"></input>
