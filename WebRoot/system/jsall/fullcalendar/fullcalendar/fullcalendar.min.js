...
(function(t, e) {
                ...
                function(e, i) {
                    ...
                    o = null;
                        ...
                        if (n[i] ? s = n[i] : Se[i] && (s = function() {
                            ...
                            Y(u);
                            if (u.html()=='今天') {
                            var html = "<span class=\"fc-header-space\"></span>"+
                            	"<div style=\"float:left;margin-left:5px;width:360px;height:30px;line-height:30px;margin-top:-10px;\">"+
    							"<span style=\"float:left;font-size:12px;\">未完成</span><div style=\"height:15px;width:30px;background-color:rgb(255, 136, 124);float:left;margin-top:7px;margin-left:3px;\"></div>"+
    							"<span style=\"float:left;margin-left:5px;font-size:12px;\">已完成</span><div style=\"height:15px;width:30px;background-color:rgb(58, 135, 173);float:left;margin-top:7px;margin-left:3px;\"></div>"+
    							"<span style=\"float:left;margin-left:5px;font-size:12px;\">进行中</span><div style=\"height:15px;width:30px;background-color:rgb(105, 240, 164);float:left;margin-top:7px;margin-left:3px;\"></div>"+
    							"<span style=\"float:left;margin-left:5px;font-size:12px;\">已超时</span><div style=\"height:15px;width:30px;background-color:rgb(245, 181, 46);float:left;margin-top:7px;margin-left:3px;\"></div>"+
    						"</div>";
    						 u.after(html);
    						}
    ...
    function te() {
        ...
        function s(n, r) {
            ...
            for (a = 0; S > a; a++) o = n[a],
            (b = o.element) && (b[0].style.width = Math.max(0, o.outerWidth - o.hsides) + "px", M = Math.max(0, o.outerHeight - o.vsides), b[0].style.height = M + "px", i = o.event, o.contentTop !== e && 10 > M - o.contentTop && (b.find("div.fc-event-time").text(re(i.start, y("timeFormat")) + " - " + i.title + "  " + i.fromName.substr(4,i.fromName.length)), b.find("div.fc-event-title").remove()), w("eventAfterRender", i, i, b))
        }
        function c(t, e) {
            var n = "<",
            r = t.url,
            ...
            n += " class='" + o.join(" ") + "'" + " style=" + "'" + "position:absolute;" + "top:" + e.top + "px;" + "left:" + e.left + "px;" + a + "'" + ">" + "<div class='fc-event-inner'>" + "<div class='fc-event-time'>" + q(ae(t.start, t.end, y("timeFormat"))) + "</div>" + "<div class='fc-event-title'>" + q(t.title || "") + "</div>" + "<div class='fc-event-title'>" + q(t.fromName || "") + "</div>" + "</div>" + "<div class='fc-event-bg'></div>",
