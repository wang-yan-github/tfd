...
var flowform_plugin_xworkflow=new Object();
$(function() {
	...
	//校验，required
	flowform_plugin_xworkflow.validate=function() {
	...
	// 转换dom节点，required
	flowform_plugin_xworkflow.toDomStr=function() {
		var title = $("#title").val();
		var fieldName = $("#fieldName").val();
		var model = $("#model").val();
		
		var html = "<img " +
				   "	src='"+contextPath+"/system/styles/images/workflow/workflow.png'"+	
				   "	type='text' " +
				   "	xtype='xworkflow' "+
				   "	datatype='text' " +
				   "	name='" + fieldName + "' " +
	...
	if (element != null && element.getAttribute('xtype') == 'xworkflow') {
