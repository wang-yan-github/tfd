var flowform_plugin_xuploads=new Object();
$(function() {
	...
	//校验，required
	flowform_plugin_xuploads.validate=function() {
	...
	// 转换dom节点，required
	flowform_plugin_xuploads.toDomStr=function() {
		var title = $("#title").val();
		var fieldName = $("#fieldName").val();
		var html = "<input " +
				   "	type='file' " +
	...
	if (element != null && element.getAttribute('xtype') == 'xuploads') {
