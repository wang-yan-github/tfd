var flowform_plugin_xiframe=new Object();
$(function() {
	...
	//校验，required
	flowform_plugin_xiframe.validate=function() {
	...
	// 转换dom节点，required
	flowform_plugin_xiframe.toDomStr=function() {
		var title = $("#title").val();
		var fieldName = $("#fieldName").val();
		var module = $("#module").val();
		var html = "<img " +
				   "	src='"+contextPath+"/system/styles/images/workflow/iframe.png'"+
				   "	xtype='xiframe' "+
				   "	datatype='text' " +
				   "	name='" + fieldName + "' " +
				   "	id='" + fieldName + "'"+
	...
	if (element != null && element.getAttribute('xtype') == 'xiframe') {
