...
<script type="text/javascript" src="<%=contextPath%>/system/attend/count/js/detail.logic.js"></script>
...
<div class="title" >
	...
	<span style="position:relative;top:4px;left:10px;">上下班查询结果 - [<%=date %>]</span>
