...
// 	$("#layout").layout({auto:true});//开启布局器
	$.addTab("tabs","tabs-content",{url:contextPath+"/system/publicdisk/manage/index.jsp",title:"公共资源",active:true});
	$.addTab("tabs","tabs-content",{url:contextPath+"/system/publicdisk/setting.jsp",title:"公共资源设置",active:false});
}
</script>
</head>
