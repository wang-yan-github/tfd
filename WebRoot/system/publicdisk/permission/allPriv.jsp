...
<body>
   ...
   <a class="list-group-item active">
      <h5 class="list-group-item-heading">
         批量设置权限<input type="hidden" id="diskId" />
      </h5>
   </a>
...
<td><div class="col-xs-9">
	...
	<input type="checkbox" value="2" checked="checked" class="privType" />管理权限
	<input type="checkbox" value="3" checked="checked" class="privType" />新建权限
	<input type="checkbox" value="4" checked="checked" class="privType" />下载/打印权限</div>
</td>
</tr>
<tr>
<td width="15%">操作:</td>
		    	...
		    	if($(this).val()=='1'){
			    	...
			    	$("input[type=checkbox]").each(function(){
					    if(this.checked){
					    	...
					    	var requestUrl= '<%=contextPath%>/tfd/system/publicdisk/act/PublicDiskAct/addPriv.act';
					 		$.ajax({
					 				url:requestUrl,
					 				data:{
					 					diskId:diskId,
			    	...
			    	$("input[type=checkbox]").each(function(){
					    if(this.checked){
					    	j++;
					    	var privType = $(this).val();
					    	var requestUrl= '<%=contextPath%>/tfd/system/publicdisk/act/PublicDiskAct/delPriv.act';
					 		$.ajax({
					 				url:requestUrl,
					 				data:{
					 					diskId:diskId,
