...
<%
		...
		String attachName = request.getParameter("extName");
		...
		poCtrl1.webOpen(path, OpenModeType.pptNormalEdit, "admin");
        	...
        	if(privFlag=="1")
        		{
		            ...
		            document.getElementById("PageOfficeCtrl1").SetEnableFileCommand(8, false); // 禁止页面设置
    		            ...
    		            document.getElementById("PageOfficeCtrl1").SetEnableFileCommand(4, false); // 禁止另存
        					...
        					{
        					document.getElementById("PageOfficeCtrl1").SetEnableFileCommand(1, true); // 打开菜单
        	            	document.getElementById("PageOfficeCtrl1").SetEnableFileCommand(2, true); // 关闭菜单
        		            ...
        		            document.getElementById("PageOfficeCtrl1").SetEnableFileCommand(6, true); // 禁止页打印预览
        		            document.getElementById("PageOfficeCtrl1").SetEnableFileCommand(7, true); // 禁止页面设置
        		            document.getElementById("PageOfficeCtrl1").SetEnableFileCommand(8, true); // 禁止页面设置
        					}
        }
        function Save() {
