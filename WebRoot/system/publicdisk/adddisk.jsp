...
<form id="form1" name="form1" class="form-horizontal" >
   ...
   <tr>
<td width="15%">排序号:</td>
<td><div class="col-xs-8 form-group" ><input class="form-control " type="text" id="diskNo" name="diskNo" /></div></td>
</tr>
<tr>
...
function addDsik(){
	var requestUrl= '<%=contextPath%>/tfd/system/publicdisk/act/PublicDiskAct/addPublicDisk.act';
	$.ajax({
		url:requestUrl,
		data:{
			diskNo:$('#diskNo').val(),
