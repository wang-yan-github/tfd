...
<form id="form1" name="form1" class="form-horizontal" >
   ...
   <tr>
   		<td width="15%" >排序号:</td>
   		<td width="75%" ><div class="col-xs-8 form-group" style="padding:0px;" ><input class="form-control "  type="text" id="fileNo" name="fileNo"  /></div><input type="hidden" id="folderId"  /></td>
   	</tr>
   	<tr>
   		<td width="15%" >文件名称:</td>
