...
//php print_r������javascriptʵ�֣��г������е�ֵ�����Գ���ʱ����
...
function CancelBuble(event) //ֹͣ�¼�ð�ݺ���,��������������
{
...
function TJF_window_close()
{
	...
	if(!pmenu || !pmain)
  {
    ...
    //2012/11/2 0:14:07 lp �����Զ���˵���OA��������Ĺرգ���nav.php�����
...
LoadScript('/tfd/system/frame/info/js/ispirit.js');