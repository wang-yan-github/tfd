...
function setwirter()
{
	window["edit"].location=contextPath+"/system/workflow/flowprocess/designflow/setprops/writer.jsp?prcsId="+prcsId+"&flowId="+flowId;
	}
function setuserpriv()
{
	window["edit"].location=contextPath+"/system/workflow/flowprocess/designflow/setprops/userpriv.jsp?prcsId="+prcsId+"&flowId="+flowId;
	}
...
{
	window["edit"].location=contextPath+"/system/workflow/flowprocess/designflow/setprops/formValidator.jsp?prcsId="+prcsId+"&flowId="+flowId;
	}
function doinit()
{
...
<a href="javascript:void(0);" class="list-group-item" onclick="setwirter();">可写字段</a>
<a href="javascript:void(0);" class="list-group-item" onclick="formValidator();">数据验证</a>
<a href="javascript:void(0);" class="list-group-item" onclick="setuserpriv();">经办权限</a>
