...
<table align="center" border="1" cellpadding="1" cellspacing="1" style="width: 700px;">
	<tbody>
		...
		<tr>
			<td>开始时间</td>
			<td><input datatype="text" fieldname="firsttime" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm'})" style="cursor: pointer;"  id="firsttime" model="{&quot;type&quot;:&quot;1&quot;,&quot;format&quot;:&quot;yyyy-MM-dd HH:mm&quot;}" style="" title="开始时间" type="text" value="时间{选择控件}" xtype="xfetch" /></td>
			<td>结束时间</td>
			<td colspan="3"><input datatype="text" fieldname="overtime" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm'})" style="cursor: pointer;"  id="overtime" model="{&quot;type&quot;:&quot;1&quot;,&quot;format&quot;:&quot;yyyy-MM-dd HH:mm&quot;}" style="" title="结束时间" type="text" value="时间{选择控件}" xtype="xfetch" /></td>
		</tr>
		<tr>
			<td>部门经理意见</td>
		...
		<tr>
			<td>人资部确认</td>
			<td colspan="5" rowspan="1"><input datatype="text" fieldname="rzbqr" disabled="disabled" readonly id="rzbqr" model="{&quot;type&quot;:&quot;12&quot;,&quot;format&quot;:null}" name="rzbqr" title="人资部签名" type="text" value="{宏控件}" xtype="xmacro" /></td>
		</tr>
	</tbody>
</table>
