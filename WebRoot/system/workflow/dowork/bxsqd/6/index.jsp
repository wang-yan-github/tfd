...
var flowId="C9175369-B468-37E9-4E10-C128C27BE59E";
var prcsId="6";
var tableName="bxsqd";
$(function(){
...
<p style="text-align: center;"><span style="font-size: 24px;">报销申请单</span></p>
...
<table align="center" border="1" cellpadding="1" cellspacing="1" style="width: 635px;">
	<tbody>
		<tr>
			...
			<td>报销人</td>
			<td><input datatype="varchar" defaultvalue="" fieldname="bxren" disabled="disabled" readonly id="bxren" maxlength="16" name="bxren" title="报销人" type="text" value="" xtype="xinput" /></td>
		</tr>
		<tr>
			<td>报销事由</td>
			<td colspan="3" rowspan="1"><textarea cols="1" datatype="text" defaultvalue="" fieldname="baoxiaoshiyou" disabled="disabled" readonly id="baoxiaoshiyou" name="baoxiaoshiyou" rows="1" style="width: 364px; height: 36px;" title="报销事由" xtype="xtextarea"></textarea></td>
		</tr>
		<tr>
			<td>合计金额大写</td>
			<td colspan="3" rowspan="1"><input datatype="varchar" defaultvalue="" fieldname="hjjedx" disabled="disabled" readonly id="hjjedx" maxlength="52" name="hjjedx" title="合计金额大写" type="text" value="" xtype="xinput" /></td>
		</tr>
		<tr>
			<td>金额小写</td>
			<td><input datatype="varchar" defaultvalue="" fieldname="jexx" disabled="disabled" readonly id="jexx" maxlength="20" name="jexx" title="金额小写" type="text" value="" xtype="xinput" /></td>
			<td>单据张数</td>
			<td><input datatype="varchar" defaultvalue="" fieldname="djzs" disabled="disabled" readonly id="djzs" maxlength="10" name="djzs" title="单据张数" type="text" value="" xtype="xinput" /></td>
		</tr>
		<tr>
			<td>部门总监签字</td>
			<td><input datatype="text" fieldname="bmzjqz" disabled="disabled" readonly id="bmzjqz" model="{&quot;type&quot;:&quot;12&quot;,&quot;format&quot;:null}" name="bmzjqz" title="部门总监签字" type="text" value="{宏控件}" xtype="xmacro" /></td>
			<td>填报人</td>
			<td><input datatype="text" fieldname="tbren" disabled="disabled" readonly id="tbren" model="{&quot;type&quot;:&quot;8&quot;,&quot;format&quot;:null}" name="tbren" title="填报人" type="text" value="{宏控件}" xtype="xmacro" /></td>
		</tr>
		<tr>
			<td>财务主管签字</td>
			<td><input datatype="text" fieldname="cwzgqz" disabled="disabled" readonly id="cwzgqz" model="{&quot;type&quot;:&quot;12&quot;,&quot;format&quot;:null}" name="cwzgqz" title="财务主管签字" type="text" value="{宏控件}" xtype="xmacro" /></td>
			<td>会计签字</td>
			<td><input datatype="text" fieldname="kjqz" disabled="disabled" readonly id="kjqz" model="{&quot;type&quot;:&quot;12&quot;,&quot;format&quot;:null}" name="kjqz" title="会计签字" type="text" value="{宏控件}" xtype="xmacro" /></td>
		</tr>
		<tr>
			<td>出纳签字</td>
			...
			<td>董事长签字</td>
			<td><input datatype="text" fieldname="ceoqz" disabled="disabled" readonly id="ceoqz" model="{&quot;type&quot;:&quot;12&quot;,&quot;format&quot;:null}" name="ceoqz" title="董事长签字" type="text" value="{宏控件}" xtype="xmacro" /></td>
		</tr>
	</tbody>
</table>
