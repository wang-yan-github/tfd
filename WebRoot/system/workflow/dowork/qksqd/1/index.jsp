...
<table align="center" border="1" cellpadding="1" cellspacing="1" style="width: 630px;">
	<tbody>
		...
		<tr>
			<td>请款时间</td>
			<td><input datatype="text" fieldname="qktime" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" style="cursor: pointer;"  id="qktime" model="{&quot;type&quot;:&quot;1&quot;,&quot;format&quot;:&quot;yyyy-MM-dd&quot;}" title="请款时间" type="text" value="时间{选择控件}" xtype="xfetch" /></td>
			<td>请款项目</td>
		...
		<tr>
			<td>出纳确认</td>
			<td colspan="3" rowspan="1"><input datatype="text" fieldname="cnqr" disabled="disabled" readonly id="cnqr" model="{&quot;type&quot;:&quot;12&quot;,&quot;format&quot;:null}" name="cnqr" title="出纳确认" type="text" value="{宏控件}" xtype="xmacro" /></td>
		</tr>
	</tbody>
</table>
