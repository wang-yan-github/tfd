...
<table align="center" border="1" cellpadding="1" cellspacing="1" style="width: 635px;">
	<tbody>
		...
		<tr>
			...
			<td>出差时间</td>
			<td><input datatype="text" fieldname="cctime" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" style="cursor: pointer;"  id="cctime" model="{&quot;type&quot;:&quot;1&quot;,&quot;format&quot;:&quot;yyyy-MM-dd&quot;}" title="出差时间" type="text" value="时间{选择控件}" xtype="xfetch" /></td>
		</tr>
		<tr>
			<td>随行人员信息</td>
		...
		<tr>
			<td>董事长意见</td>
			<td colspan="3" rowspan="1">
			<p><textarea datatype="text" defaultvalue="" fieldname="ceoyj" disabled="disabled" readonly id="ceoyj" name="ceoyj" style="width: 389px; height: 36px;" title="董事长意见" xtype="xtextarea"></textarea></p>

			<p>签名：</p>

			<p><input datatype="text" fieldname="ceoqm" disabled="disabled" readonly id="ceoqm" model="{&quot;type&quot;:&quot;12&quot;,&quot;format&quot;:null}" name="ceoqm" style="" title="董事长签名" type="text" value="{宏控件}" xtype="xmacro" /></p>
			</td>
		</tr>
		<tr>
			<td>人资部确认</td>
