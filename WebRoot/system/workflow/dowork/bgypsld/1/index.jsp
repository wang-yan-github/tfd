...
<table align="center" border="1" cellpadding="1" cellspacing="1" style="width: 720px;">
	<tbody>
		...
		<tr>
			...
			<td><input datatype="text" fieldname="sqtime" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" style="cursor: pointer;"  id="sqtime" model="{'type':'1','format':'yyyy-MM-dd'}" title="申请时间" type="text" value="时间{选择控件}" xtype="xfetch" /></td>
