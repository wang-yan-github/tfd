...
<table align="center" border="1" cellpadding="1" cellspacing="1" style="width: 720px;">
	<tbody>
		...
		<tr>
			...
			<p><textarea datatype="text" defaultvalue="" fieldname="bmspyi" disabled="disabled" readonly id="bmspyi" name="bmspyi" style="width: 434px; height: 84px;" title="部门审批意见" xtype="xtextarea"></textarea></p>

			<p>签名：</p>

			<p><input datatype="text" fieldname="bmldqm" disabled="disabled" readonly id="bmldqm" model="{'type':'12','format':null}" name="bmldqm" title="部门领导签名" type="text" value="{宏控件}" xtype="xmacro" /></p>
			</td>
		</tr>
		<tr>
			<td>行政审批</td>
