...
<table align="center" border="1" cellpadding="1" cellspacing="1" style="width: 800px;">
	<tbody>
		...
		<tr>
			<td>流程选择：</td>
			<td><img datatype="text" fieldname="selworkflow" onclick="selectworkflow('selworkflow','1');" id="selworkflow" model="1" name="selworkflow" src="/tfd/system/styles/images/workflow/workflow.png" title="流程选择" value="1" xtype="xworkflow" /></td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
		</tr>
		<tr>
