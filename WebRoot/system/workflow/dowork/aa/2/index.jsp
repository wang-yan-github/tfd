...
<p>单行：<input datatype="varchar" defaultvalue="" fieldname="danhang" disabled="disabled" readonly id="danhang" maxlength="11" name="danhang" title="单行" type="text" value="" xtype="xinput" /></p>

<p>多行文本：<textarea datatype="text" defaultvalue="" fieldname="duohang" disabled="disabled" readonly id="duohang" name="duohang" style="" title="duohang" xtype="xtextarea"></textarea></p>

<p>宏：<span xtype="macrotag" value="MACRO_RUN_NAME"></span><span xtype="macrotag" value="MACRO_NUMBERING"></span><span xtype="macrotag" value="MACRO_BEGIN_TIME"></span></p>

<p>年度：<input datatype="text" fieldname="hongkongjian" disabled="disabled" readonly id="hongkongjian" model="{&quot;type&quot;:&quot;1&quot;,&quot;format&quot;:&quot;yyyy年&quot;}" name="hongkongjian" style="" title="hong" type="text" value="{宏控件}" xtype="xmacro" /></p>
