...
<span class="title_name">流程级别设置</span>
</div>
</div>
</div>
	<div layout="west" id="west" min=20 width=250 style="width:250px;">
	<iframe name="left" height="100%" width="100%" frameborder="0" scrolling="auto" src="<%=contextPath%>/system/workflow/leadleave/prcstree.jsp"></iframe>
	</div>
<div layout="center">
	<iframe name="edit" height="100%" width="100%" frameborder="0" id="edit"  src="<%=contextPath%>//system/workflow/leadleave/info.jsp"></iframe>
	</div>
</div>
</body>
</html>