...
function editinfo(event, treeId, treeNode)
{
	if(!treeNode.isParent)
		{
			parent["edit"].location=contextPath+"/system/workflow/workflow/manage.jsp?flowTypeId="+treeNode.id
		}else
		{
			parent["edit"].location=contextPath+"/system/workflow/workflow/workflowlist.jsp?sortId="+treeNode.id
		}
}
function add()
{
	parent["edit"].location=contextPath+"/system/workflow/workflow/add.jsp"
	}
</script>
</head>
