...
<script type="text/javascript" src="<%=contextPath%>/system/publicfilefolder/manage/js/manage.js"></script>
...
<body>
	<div class="panel panel-info" style="height:100%;background-color:#F5F5F5;overflow:auto;" >
   ...
   <table class="table table-striped  table_btn" >
   	<tr style="background-color:#F5F5F5;" >
   		...
   		<button id='go_new' style="display:none;float:left;margin-left:5px;" class='btn btn-primary'>新建文件</button>
   		<button  id='newChild' style="display:none;float:left;margin-left:5px;" class='btn btn-primary'>新建文件夹</button>
   		...
   		<button id="setPriv" style="display:none;float:left;margin-left:5px;" class="btn btn-primary">设置权限</button>
   		<button data-toggle="modal" data-target="#myModal_update" id="btn_edit" style="display:none;float:left;margin-left:5px;" class="btn btn-success">编辑</button>
   		</td>
   	</tr>
   	<tr style="background-color:#F5F5F5;border-bottom:#CCC 1px solid;">
   		...
   		<div style="width:80px;float:left;margin-left:30px;" >
   			...
   			<button id='btn_shera_paste' style="float:left;margin-left:5px;display:none;"  class='btn btn-success'>粘贴</button>
   			<button id='btn_copy_paste' style="float:left;margin-left:5px;display:none;" class='btn btn-success'>粘贴</button>
   		</td>
   	</tr>
</table>
</div>
