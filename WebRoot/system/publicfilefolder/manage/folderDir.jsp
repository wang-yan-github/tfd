...
function getChild(event,treeId,treeNode){
	...
	parent["right"].location=contextPath+"/system/publicfilefolder/manage/manage.jsp?folderId="+encodeURIComponent(treeNode.id)+"&folderName="+encodeURIComponent(treeNode.name)+"&folderNo="+encodeURIComponent(treeNode.folderNo); 
}
