...
var editor;
	...
	function editFile(){
		...
		var requestUrl= '<%=contextPath%>/tfd/system/folder/act/FolderAct/updateFile.act';
 		$.ajax({
			url:requestUrl,
			type:"POST",
			data:{
	...
	function doinit(){
		...
		$.ajax({
			...
			success:function(data){
				...
				//creatAttachDivForFile(attachId,"attach",4,fileId);
...
<form id="form1" name="form1" class="form-horizontal" >
   ...
   <tr>
   		<td width="15%" >排序号:</td>
   		<td width="75%" ><div class="col-xs-8 form-group" style="padding:0px;" ><input class="form-control "  type="text" id="fileNo" name="fileNo"  /><input type="hidden" id="folderId"  /></td>
   	</tr>
   	<tr>
   		<td width="15%" >文件名称:</td>
   	...
   	<tr>
   		<td width="15%" >文件内容:</td>
   		<td width="75%" ><div id="editor" type="text/plain" style="width: 100%; height: 200px;">
...
<div>
	...
	<input type="file" onchange="fileUpLoad('publicfolder','attach');" hidefocus="true" size="1" id="fileattach" name="fileattach" class="addfile"></a>
