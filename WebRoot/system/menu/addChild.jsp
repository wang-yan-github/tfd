...
<%
	String sysMenuLeave = request.getParameter("sysMenuLeave");
	String sysMenuLeaveName = request.getParameter("sysMenuLeaveName");
%>
<html>
<head>
	...
	<script type="text/javascript" src="<%=contextPath%>/system/menu/js/addChild.js"></script>
	<script type="text/javascript">
		sysMenuLeave="<%=sysMenuLeave%>";
		sysMenuLeaveName="<%=sysMenuLeaveName%>";
	</script>
	<style>
		.menuContent{
			height:300px;
