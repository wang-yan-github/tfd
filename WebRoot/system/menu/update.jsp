...
<head>
	...
	<script type="text/javascript" src="<%=contextPath%>/system/menu/js/update.js"></script>
		...
		<div style="width: 70%;margin:0px auto;margin-top:10px;">
			...
			<div align="center" class="widget">
				<div class="widget-header bordered-bottom bordered-sky">
					<span class="widget-caption">修改菜单</span>
				</div>
				<table class="table table-striped  table-condensed table-bordered">
					...
					<tr>
						...
						<td>
							<div class="col-xs-6">
								<select id="sysMenuOpen" name="sysMenuOpen" class="form-control">
			...
			<div style="text-align: center;">
				...
				<button type="button" class="btn btn-success" id="add-child">添加子菜单</button>
