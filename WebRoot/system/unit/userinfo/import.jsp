...
<head>
    ...
    <script type="text/javascript" src="<%=contextPath%>/system/jsall/bootstrap/js/bootstrap.min.js"></script>
  	...
  	<script type="text/javascript" src="<%=contextPath%>/system/unit/userinfo/js/import.logic.js"></script>
  	<script>
  ...
  <div class="container" id="body">
	 <div class="north">
	    <form class="form-inline" id="import-form" 
	    		action="<%=contextPath%>/tfd/system/unit/userinfo/act/UserInfoImportAct/dataImport.act" method="post" enctype="multipart/form-data">
	      <div class="row">
	      	<div class="col-xs-8 col-xs-offset-2">
	       	<span class="h3">用户信息导入</span>
	       	<a id="template-download" href="<%=contextPath%>/tfd/system/unit/userinfo/act/UserInfoImportAct/templateDownload.act">下载模板</a>
	      	</div>
	      </div>
	      <br/>
	      <div class="row">
