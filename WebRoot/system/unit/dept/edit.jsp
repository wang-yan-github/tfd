...
<script type="text/javascript" src="<%=contextPath%>/system/jsall/api/sys.unit.dept.api.js"></script>
<script type="text/javascript" src="<%=contextPath%>/system/unit/dept/js/edit.logic.js"></script>
<script>
	unit_dept_edit.deptId="<%=deptId%>";
</script>
<style>
...
<body>
	...
	<div class="container">
		<form id="dept-form" class="form-horizontal">
			...
			<input name="orgLeaveId" type="hidden" />
			<input name="deptLead" id="deptLead" type="hidden"/>
			
			<input name="parentDeptLongId" type="hidden"/>
			<input name="parentDeptLongName" type="hidden"/>
			
			<div class="list-group-item well with-header  with-footer">
				<div class="header bg-darkorange" id="header-dept-edit">编辑部门</div>
				<table class="table table-striped table-condensed">
					<tr>
						<td width="150px;">上级部门：</td>
						<td>
							<div class="col-xs-6 form-group">
								<input class="form-control" name="orgLeaveName" readonly="readonly"/>
			...
			<div class="col-xs-12" id="opt-bar">
				<button type="submit" class="btn btn-info">保存</button>
				<button type="button" class="btn btn-info" id="dept-delete">删除</button>
			</div>
		</form>
	</div>
