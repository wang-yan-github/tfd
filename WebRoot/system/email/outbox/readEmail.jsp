...
.buttons{width:350px;float:right;}
...
<body>
	<div class=title >
		...
		<div class="buttons" >
			<input type="button" class="btn btn-info" id="restore"  value="恢复" />
			<input type="button" class="btn btn-danger" id="deleteEmail" value="彻底删除" />
			<input type="button" class="btn btn-success" onclick="javascript:goPrint(4)"   value="打印" />
			<input type="button" class="btn btn-default" onclick="javascript:goLast(4)" value="上一封" />
			<input type="button" class="btn btn-default" onclick="javascript:goNext(4)" value="下一封" />
		</div>
	</div>
	<div class="table" >
		<div class="info">
