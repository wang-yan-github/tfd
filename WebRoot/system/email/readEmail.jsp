...
<body>
	<div class=title >
		...
		<div class="buttons" >
			...
			<input type="button" class="btn btn-success" onclick="javascript:goPrint('<%=boxId%>')"    value="打印" />
			<input type="button" class="btn btn-default" onclick="javascript:goLast('<%=boxId%>')" value="上一封" />
			<input type="button" class="btn btn-default" onclick="javascript:goNext('<%=boxId%>')"  value="下一封" />
...
$(function(){
	...
	$('#reply').click(function(){
		window.location.href = "inbox/reply.jsp?emailId="+id+"&i="+"2";
	})
	$('#replys').click(function(){
		window.location.href = "inbox/reply.jsp?emailId="+id+"&i="+"3";
	})
	$('#forward').click(function(){
		window.location.href = "inbox/reply.jsp?emailId="+id+"&i="+"4";
	})
