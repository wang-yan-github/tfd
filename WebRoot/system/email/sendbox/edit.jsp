...
<td>
	...
	<a href="javascript:void(0);" style="position:relative;left:-70px;top:38px;" href="javascript:void(0);" id="showOther" onclick="showTr('Other','抄送')" >添加抄送</a>
	<a href="javascript:void(0);" style="position:relative;left:-40px;top:38px;" href="javascript:void(0);" id="showWeb" onclick="showTr('Web','web收件人')" >添加web收件人</a>
</td>
</tr>
...
$(function(){
	...
	$('#btn_back').click(function(){
		window.location.href="readEmail.jsp?emailId="+id+"&boxId=2";
		return false;
	})
})
</script>
