...
<body>
	<div class=title ><span>发件箱</span>
		<div class="input-group" style="float:right;width:240px;margin-top:3px;margin-right:20px;">
               <input type="text" placeholder="在发件箱中搜索" id="searchContent" class="form-control" style="width:200px;height:35px;" >
...
var boxId = "<input  id=\"checkAll\" type=checkbox /><input class=\"btn btn-info\" style=\"margin-left:10px;\" type=button onclick=javascript:sendEmailAgain('') value=再次发送 /><input style=\"margin-left:10px;\" class=\'btn btn-danger\' onclick=deleteEmail('') type=button value=彻底删除 />";
$(".buttons").html(boxId);
var boxIds = "2";
$(function(){
	var urls = '<%=contextPath%>/tfd/system/email/act/EmailAct/getEmailList.act?boxId=2';
	getEmail("");
