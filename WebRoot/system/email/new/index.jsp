...
<td>
	<div class="col-xs-4 form-group">
		...
		<textarea rows="3" cols="40" readonly="readonly" name="userName" id="userName" style="resize:none;" class="form-control"></textarea></div>
	...
	<a style="position:relative;left:-70px;top:38px;"  id="showOther" onclick="showTr('Other','抄送')" >添加抄送</a>
	<a style="position:relative;left:-40px;top:38px;"  id="showWeb" onclick="showTr('Web','web收件人')" >添加web收件人</a>
</td>
</tr>
...
<td><div class="col-xs-4">
         <input type="text" class="form-control" placeholder="xxxx@163.com" id=WebMail name="WebMail"></div>
</tr>
<tr>
<td width="10%">主题:</td>
...
$(function(){
	...
	$('#btn_back').click(function(){
		window.location.href = contextPath+ "/system/email/inbox/index.jsp";
		return false;
	})
})
</script>
