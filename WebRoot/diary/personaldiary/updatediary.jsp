...
<script type="text/javascript" src="<%=contextPath%>/diary/personaldiary/js/updatediary.js"></script>
...
<a style="cursor: auto;" class="list-group-item active">日志修改</a>
...
<tr>
	<td colspan="2">
	<textarea  id="editor" name="editor" style="width: 90%; height: 180px;" ></textarea>
...
<div>
	...
	<tr>
	<td  id="updatetd" colspan="2" align="right">
	<input type="button" onclick="updatediary();" class="btn btn-primary" value="修改">
