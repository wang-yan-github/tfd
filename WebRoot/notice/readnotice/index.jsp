...
// 	$("#layout").layout({auto:true});//开启布局器
	$.addTab("tabs","tabs-content",{url:contextPath+"/notice/readnotice/noreadnotice.jsp",title:"未读公告",active:true});
	$.addTab("tabs","tabs-content",{url:contextPath+"/notice/readnotice/passreadnotice.jsp",title:"已读公告",active:false});
	$.addTab("tabs","tabs-content",{url:contextPath+"/notice/readnotice/oldreadnotice.jsp",title:"历史公告",active:false});
	$.addTab("tabs","tabs-content",{url:contextPath+"/notice/readnotice/querynotice.jsp",title:"公告查询",active:false});
}
</script>
</head>
