...
<script type="text/javascript" src="<%=contextPath%>/notice/manage/js/approvalview.js"></script>
<script type="text/javascript" src="<%=contextPath%>/notice/manage/js/managenotice.js"></script>
...
<span class="title_name" >公告管理
</span>
<div class="col-xs-12 form-group" style="float: left;margin-top:8px; width: 150px;display: none;" id="noticeSelect">
<div id="noticeType"></div>
</div>
</div>
<div style=" float: right;margin-top:15px;margin-right: 20px; display: none;" id="btnitem">
       <button type="button" class="btn btn-danger btn-sm"  onclick="delnotice();">删除</button>
       <button type="button" class="btn btn-warning btn-sm"  onclick="endsnotice('1');">终止所选公告</button>
       <button type="button" class="btn btn-primary btn-sm"  onclick="endsnotice('0');">生效所选公告</button>
...
<input id="noticeId" name="noticeId" type="hidden"></input>
...
<table class="MessageBox" style="display:none;margin-top:100px;" align="center" width="440" cellpadding="0" cellspacing="0">
	   ...
	   <tr class="msg">
	      ...
	      <td class="center info">
	         <div class="msg-content">没有发布公告</div>
	      </td>
	      <td class="right"></td>
	   </tr>
	   <tr class="foot">
