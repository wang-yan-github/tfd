...
<script type="text/javascript" src="<%=contextPath%>/notice/manage/js/editnotice.js"></script>
...
<a style="cursor: auto;" class="list-group-item active">公告修改</a>
<table class="table table-striped table-condensed">
<tr>
<td width="15%">公告标题:</td>
<input type="hidden" name="approvalstaff" id="approvalstaff">
<td><div class="col-xs-4 form-group"><input type="text" id="noticeTitle" name="noticeTitle" class="form-control"></div></td>
</tr>
<tr>
<td>公告类型:</td>
<td>
...
<td>
<div class="col-xs-4 form-group">
<textarea rows="3" cols="40" name="deptPriv" id="deptPriv" style="display:none;"  class="form-control"></textarea>
...
<tr>
<td style="width:20%;">查阅权限(人员):</td>
<td style="width:80%;">
<div class="col-xs-4 form-group">
<textarea rows="3" cols="40" name="accountId" id="accountId" style="display:none;" class="form-control"></textarea>
...
<td>发布时间:</td>
<td>
<div class="col-xs-4"><input type="text" name="createTime" id="createTime" size="20" readonly="readonly" style="cursor: pointer;"
...
<button type="button" class="btn btn-info" onclick="updatenotice();">保存</button>
