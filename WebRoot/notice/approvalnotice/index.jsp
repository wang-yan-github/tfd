...
// 	$("#layout").layout({auto:true});//开启布局器
	$.addTab("tabs","tabs-content",{url:contextPath+"/notice/approvalnotice/noapproval.jsp",title:"待审批公告",active:true});
	$.addTab("tabs","tabs-content",{url:contextPath+"/notice/approvalnotice/alreadyapproval.jsp",title:"已审批公告",active:false});
}
</script>
</head>
